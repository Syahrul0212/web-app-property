        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Toko Property Terpercaya di Indonesia. Jual Beli Aman & Harga Termurah! Beli
                        sekarang.
                    </p>
                    <div class="social">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <hr style="border-top: 3px solid rgb(226 232 240);border-radius:.5rem">
                    <p>
                        <i class="fa fa-clock"></i> Rahmad Property Buka Setiap Hari :
                        <br>
                        Senin - Minggu ( 08.00 s/d 22.00 )
                    </p>
                    <p>
                        <i class="fa fa-map-marker"></i> Perumahan Duta Bintaro Cluster Kintamani B 11 No 02
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Rahmad Property</strong> 2023 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
